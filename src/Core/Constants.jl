...
const BODIES_DATA = Dict(
    ...
    :moon  => (
        name=:moon, mu=4.90280012e3*km^3/s^2, R=1738.1*km, d_AU=1.0u"AU", a_earth_km=384400.0*km, e_earth=0.0549,
        ...
        :mercury => (
            ...
            j2 = 5.029142692827439e-5, j3 = 1.2631611223640442e-5, j4 = 1.7445074222489103e-5, 
            j5 = -7.132655160651639e-7, j6 = -5.586129384067931e-6, j7 = 1.2846439492925317e-6, 
            j8 = 5.039282770243371e-6,
            c22 = 8.04151214871298e-6, c31 = -3.8636762833120465e-6, c32 = 3.226113934372156e-7, 
            c33 = 8.489291189563887e-8, c41 = 1.6004411381069617e-6, c42 = 4.298112261645634e-7, 
            c43 = -4.837003327855751e-8, c44 = 1.0876540647942266e-10,
            s22 = -2.7165297405833576e-9, s31 = -2.8331490953288825e-6, s32 = -2.0639906473650406e-7, 
            s33 = 2.3131011237197108e-7, s41 = 3.139830005379863e-6, s42 = 6.374648974420028e-7, 
            s43 = 8.543489869666772e-8, s44 = -6.811240719470399e-9,
    ...
    # ref. didymos: maxima function based in Balmino, G. (1994). Gravitational potential harmonics from the shape of an homogeneous body. Celest. Mech. Dyn. Astron. 60, 331-364.
    # Equation (69), p. 347.
    ...
    :didymos => (
        name=:didymos, mu=3.489324040e-8*km^3/s^2, R=0.39*km, j2 = 1.58218277e-2, j4 = -5.50620800e-4, j6 = 2.54475880e-5, j8 = -1.37657999e-6,
        c22 = 1.82018409e-3, c42= -2.05704565e-5, c44=5.91619664e-7, c62 = 5.49616077e-7, omega_rot=0.0007725088531821048*rad/s, spice_id="920065803"
    ), 
