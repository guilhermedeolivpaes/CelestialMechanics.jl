...
const BODIES_DATA = Dict(
    ...
    :moon  => (name=:moon, mu=4.90280012e3*km^3/s^2, R=1738.1*km, d_AU=1.0u"AU", a_earth_km=384400.0*km, e_earth=0.0549,
                j2=0.909010949481e-4, j3=0.320307167959e-5, j4=-0.321409545028e-5, j5=0.221009876393e-6, j6=-0.376479064475e-5, 
                j7=-0.561330656403e-5, j8=-0.231953905520e-5, j9=0.354241582136e-5, j10=0.933036285877e-6, j11=0.960353139804e-6, 
                j12=0.188692162540e-5,
                j13=-0.258650494877e-6, j14=-0.326300330782e-6, j15=0.972530852999e-6, j16=-0.318446040132e-6,
                j17=0.103822696054e-5, j18=0.372937482506e-6, 
                c22=0.346376274208e-4, c31=0.263418358622e-4, c32=0.141853316786e-4, c33=0.122862645044e-4, 
                s22=0.144063503540e-7, s31=0.546307860882e-5, s32=0.488913911795e-5, s33=-0.178246270720e-5, omega_rot=2.6617e-6*rad/s,
                spice_id="MOON"), # source: gagg and sandro, 2025 a semi-analytic theory for preliminary.... 
